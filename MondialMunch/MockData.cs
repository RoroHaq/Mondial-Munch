...
public class MockData {
    public static List<User> Users = new(){
        ...
        new("Andrew", "img/something.png", "This is Andrew.",
                            Country.Canada, Country.United_States, "password123", User.GenerateSalt()),
        new("Safin", "img/something.png", "I am Safin.",
                            Country.Mexico, Country.Canada, "password123", User.GenerateSalt())
    };

    public static List<Recipe> Recipes = new() {
        new ("Poutine", Users[0], "Iconic Canadian dish", 1, 10, 10, Country.Canada,
        ...
        new ("Burger", Users[1], "America's best!", 2, 5, 20, Country.United_States,
        ...
        new ("Tacos", Users[2], "Very good tacos", 3, 5, 40, Country.Mexico,
