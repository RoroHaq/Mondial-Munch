...
public class UserClassTest {
    ...
    public void ChangeCurrentCountryPictureTest() {
        ...
        if (testUser.ChangeCurrentCountry("password123", new Country("United States")) != true) {
            Assert.Fail();
        }

        Assert.AreEqual(new Country("United States"), testUser.CountryCurrent);
    }
    ...
    public void ChangeCurrentCountryInvalidPassword() {
        ...
        Assert.IsFalse(testUser.ChangeCurrentCountry("password124", new Country("United States")));
    }
    ...
    public void AddToFavouriteRecipiesTest() {
        ...
        Recipe recipe = new("Tacos", testUser, "made in the depths of hell", 5, 3, 15,
                            new Country("Mexico"), steps, ingredients);
